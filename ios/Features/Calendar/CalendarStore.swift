...
public final class CalendarStore {
    ...
    public static func mockEntries(reference: Date = Date(), calendar: Calendar = .current) -> [CalendarEntry] {
        ...
        let entries: [CalendarEntry?] = [
            // This month
            makeEvent("Daily Standup", description: "Quick sync with the mobile team.", dayOffset: 0, hour: 9, durationMinutes: 30),
            makeEvent("Product Design Review", description: "Review latest Kinnect designs.", dayOffset: 0, hour: 11, durationMinutes: 75),
            makeEvent("Client Check-In", description: "Weekly status update.", dayOffset: 3, hour: 14, minute: 30, durationMinutes: 45),

            // Next month
            makeEventInMonthOffset("Monthly All-Hands", description: "Company-wide updates.", monthOffset: 1, day: 5, hour: 10, durationMinutes: 60),
            makeEventInMonthOffset("iOS Release Retro", description: "Reflect on last release.", monthOffset: 1, day: 12, hour: 15, durationMinutes: 45),

            // Two months out
            makeEventInMonthOffset("Planning Offsite", description: "Quarterly roadmap planning.", monthOffset: 2, day: 18, hour: 9, durationMinutes: 8 * 60),

            // Six months out
            makeEventInMonthOffset("Midyear Review", description: "Performance check-in.", monthOffset: 6, day: 20, hour: 13, durationMinutes: 60),

            // One year out
            makeEventInMonthOffset("Anniversary Launch", description: "Celebrate 1 year milestone.", monthOffset: 12, day: 1, hour: 10, durationMinutes: 120),

            // Two years out
            makeEventInMonthOffset("Long-term Strategy", description: "Multi-year planning.", monthOffset: 24, day: 7, hour: 11, durationMinutes: 90),

            // Four years out
            makeEventInMonthOffset("Platform Migration", description: "Infra overhaul planning.", monthOffset: 48, day: 15, hour: 9, durationMinutes: 180)
        ]
